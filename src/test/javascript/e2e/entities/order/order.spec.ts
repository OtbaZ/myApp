...
describe('Order e2e test', () => {
  ...
  it('should load Orders', async () => {
    ...
    expect(await orderComponentsPage.getTitle()).to.eq('myApp.order.home.title');
  ...
  it('should load create Order page', async () => {
    ...
    expect(await orderUpdatePage.getPageTitle()).to.eq('myApp.order.home.createOrEditLabel');
  ...
  it('should delete last Order', async () => {
    ...
    expect(await orderDeleteDialog.getDialogTitle()).to.eq('myApp.order.delete.question');
