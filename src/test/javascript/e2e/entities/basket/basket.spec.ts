...
describe('Basket e2e test', () => {
  ...
  it('should load Baskets', async () => {
    ...
    expect(await basketComponentsPage.getTitle()).to.eq('myApp.basket.home.title');
  ...
  it('should load create Basket page', async () => {
    ...
    expect(await basketUpdatePage.getPageTitle()).to.eq('myApp.basket.home.createOrEditLabel');
  ...
  it('should delete last Basket', async () => {
    ...
    expect(await basketDeleteDialog.getDialogTitle()).to.eq('myApp.basket.delete.question');
