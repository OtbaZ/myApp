...
describe('Restaurant e2e test', () => {
  ...
  it('should load Restaurants', async () => {
    ...
    expect(await restaurantComponentsPage.getTitle()).to.eq('myApp.restaurant.home.title');
  ...
  it('should load create Restaurant page', async () => {
    ...
    expect(await restaurantUpdatePage.getPageTitle()).to.eq('myApp.restaurant.home.createOrEditLabel');
  ...
  it('should delete last Restaurant', async () => {
    ...
    expect(await restaurantDeleteDialog.getDialogTitle()).to.eq('myApp.restaurant.delete.question');
