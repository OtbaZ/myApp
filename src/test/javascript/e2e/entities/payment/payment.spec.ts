...
describe('Payment e2e test', () => {
  ...
  it('should load Payments', async () => {
    ...
    expect(await paymentComponentsPage.getTitle()).to.eq('myApp.payment.home.title');
  ...
  it('should load create Payment page', async () => {
    ...
    expect(await paymentUpdatePage.getPageTitle()).to.eq('myApp.payment.home.createOrEditLabel');
  ...
  it('should delete last Payment', async () => {
    ...
    expect(await paymentDeleteDialog.getDialogTitle()).to.eq('myApp.payment.delete.question');
