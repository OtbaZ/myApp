...
describe('Cooperative e2e test', () => {
  ...
  it('should load Cooperatives', async () => {
    ...
    expect(await cooperativeComponentsPage.getTitle()).to.eq('myApp.cooperative.home.title');
    await browser.wait(
  ...
  it('should load create Cooperative page', async () => {
    ...
    expect(await cooperativeUpdatePage.getPageTitle()).to.eq('myApp.cooperative.home.createOrEditLabel');
  ...
  it('should delete last Cooperative', async () => {
    ...
    expect(await cooperativeDeleteDialog.getDialogTitle()).to.eq('myApp.cooperative.delete.question');
